...
@RestController
@RequestMapping("/api/democracy-department-ms-kafka")
public class DemocracyDepartmentMsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DemocracyDepartmentMsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public DemocracyDepartmentMsKafkaResource(KafkaProperties kafkaProperties) {
